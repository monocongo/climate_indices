...
1. **For understanding computation**: Start with `docs/algorithms.rst` (Sphinx), then `src/climate_indices/compute.py`
...
**Next Steps**: See [architecture.md](./architecture.md) for detailed technical architecture, [development-guide.md](./development-guide.md) for setup instructions, and [algorithms.rst](./algorithms.rst) for mathematical specifications.
