...
--input_file C:/home/data/nclimdiv/nclimdiv_processed_test.nc --precip_var_name pdat --temp_var_name tdat --awc_var_name awc --output_dir C:/home/data/nclimdiv/compare_divisions_allnew
    '''
...
#                 # FOR DEBUG/DEVELOPMENT ONLY -- REMOVE
                ...
                expected_pdsi = input_dataset.variables['cmb_pdsi'][division_index, :]
                expected_phdi = input_dataset.variables['cmb_phdi'][division_index, :]
                expected_pmdi = input_dataset.variables['cmb_pmdi'][division_index, :]
                expected_zindex = input_dataset.variables['cmb_zndx'][division_index, :]
