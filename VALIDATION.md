...
treated as independent validation for 3.0.0 because its provenance identifies the
source as "climate_indices library reference output."

Before closing the 3.0.0 scientific validation checklist, one of these must be
completed:
