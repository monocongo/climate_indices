...
| Validation marker suite | `uv run pytest -m validation` | External validation tests, including committed NOAA EDDI fixtures and the standard-Palmer nClimDiv comparison, pass; scPDSI oracle cross-validation and all regression coverage pass. |
