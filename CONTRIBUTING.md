...
- `Amended` — the decision stands, but a later change moved its detail: a symbol
  was renamed, a deferral completed, a module became a package. Correct the
  detail in place and name the change and the commit or issue that made it. An
  amendment corrects names and facts and keeps the reasoning that led to the
  decision legible; it does not rewrite it.
