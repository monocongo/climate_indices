...
It is critical that you pull upstream changes from master branch into your fork on a regular basis. Nothing is worse than putting in a days of hard work into a pull request only to have it rejected because it has diverged too far from the main branch.
...
`git pull git://github.com/<submitter-github-name/indices_python.git master`
