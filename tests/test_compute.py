...
class ComputeTestCase(fixtures.FixturesTestCase):
    ...
    def test_pearson3_fitting_values(self):
        ...
        expected_values = np.array([[0.0, 0.008, 0.0, 0.008, 0.0164, 0.0164, 0.0, 0.0, 0.0, 0.0164, 0.0, 0.008],
                                    [45.85, 46.35, 48.32, 67.64, 121.17, 184.13, 154.97, 170.29, 196.43, 153.53,
                                     58.40, 38.86],
                                    [38.87, 35.33, 34.32, 50.26, 73.52, 100.18, 50.63, 63.07,
                                     75.26, 93.67, 48.75, 33.01],
